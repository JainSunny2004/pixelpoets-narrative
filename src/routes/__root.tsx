...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "PixelPoets Productions — Cinematic Brand Storytelling" },
      { property: "og:description", content: "A creative agency for visual storytelling — brand films, AI ads, virtual tours, and corporate documentaries." },
      { property: "og:type", content: "website" },
      { property: "og:site_name", content: "PixelPoets Productions" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "theme-color", content: "#0e0d0b" },
      { name: "twitter:title", content: "PixelPoets Productions — Cinematic Brand Storytelling" },
      { name: "twitter:description", content: "A creative agency for visual storytelling — brand films, AI ads, virtual tours, and corporate documentaries." },
      { property: "og:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/127680dd-f0bf-4705-a83e-d6b26ce191a0/id-preview-af8683ec--74a0e132-72f6-443d-ad73-ec22b8abe5d1.lovable.app-1778849013285.png" },
      { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/127680dd-f0bf-4705-a83e-d6b26ce191a0/id-preview-af8683ec--74a0e132-72f6-443d-ad73-ec22b8abe5d1.lovable.app-1778849013285.png" },
    ],
    links: [
